...
class InsertProductUseCaseUnitTest {
    @Mock
    private InsertProductOutputPort outputPort;
    @InjectMocks
    ...
    void givenValidatedProduct_whenExecute_capturedErrorsShouldStayEmpty() {
        ...
        useCase.execute(product, capturedErrors);

        assertTrue(capturedErrors.isEmpty());
    }

    @Test
    @DisplayName("Given null name, when execute, should put validation error on map")
    void givenInvalidName_whenExecute_shouldPutValidationErrorOnMap() {
        Product product = ProductFixture.gimmeSingleProduct();
    ...
    @Test
    @DisplayName("Given null description, when execute, should put validation error on map")
    void givenInvalidDescription_whenExecute_shouldPutValidationErrorOnMap() {
        Product product = ProductFixture.gimmeSingleProduct();
    ...
    @Test
    @DisplayName("Given null price, when execute, should put validation error on map")
    void givenInvalidPrice_whenExecute_shouldPutValidationErrorOnMap() {
        Product product = ProductFixture.gimmeSingleProduct();
